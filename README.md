...
**AI / Data / Infra**  
`LangGraph` · `OpenAI` · `vLLM` · `Pinecone` · `MongoDB` · `SQL / MySQL / Oracle SQL` · `Pandas` · `NumPy` · `Spark`

**Backend & Systems**  
`FastAPI` · `Flask` · `Node.js` · `Django` · `NestJS` · `Docker` · `AWS`

**Frontend & UX**  
`React` · `Next.js` · `HTML` · `CSS` · `TypeScript`
...
- McKinsey.org **Forward Program** – Professional Skills
